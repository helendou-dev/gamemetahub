"""Remove Hunyuan watermark and resize to 1408x704 for Trails in the Sky 2nd Chapter ss2."""
from PIL import Image, ImageFilter, ImageOps
import os

SRC = "/Users/Zhuanz/WorkBuddy/GameMetaHub/gaming-hotwords/website/generated-images/Anime_JRPG_scene_with_a_brave__2026-09-20T02-25-17.png"
DST = "/Users/Zhuanz/WorkBuddy/GameMetaHub/gaming-hotwords/website/public/images/games/trails-in-the-sky-2nd-chapter-ss2-v20260920.jpg"
TARGET = (1408, 704)
...
if __name__ == "__main__":
    ...
    out = Image.open(DST)
    W, H = out.size
    out.crop((W-260, H-140, W, H)).resize((780, 420), Image.LANCZOS).save("/tmp/after_trails_sky_ss2.png")
    print(f"Verification probe saved to /tmp/after_trails_sky_ss2.png")
